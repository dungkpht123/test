            ...
            <div class="row">
                <div class="col-lg-10 col-md-12 offset-lg-1">
                    <div class="impl_help_data">
                        ...
                        <div class="impl_help_no"><span>18000191</span></div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12">
                                <div class="impl_post_data">
                                    <h2><a href="blog_left_sidebar.html">VinFast thắng lớn, giành 3 giải nhất trong Bình chọn “Xe của năm 2021” tại Việt Nam </a></h2>
                    ...
                    <div class="impl_blog_box impl_blog_right">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12 pull-lg-4">
                                <div class="impl_post_data">
                                    <h2><a href="blog_left_sidebar.html">VinFast công bố 2 mẫu xe điện mới tại Los Angeles Auto Show 2021 </a></h2>
